...
class DataProcessor:
    ...
    def init_session():
    """Inizializza oggetti session_state se non presenti"""
    ...
    def main():
        ...
        init_session()  # ✅ Assicura che tutto sia pronto

        if 'df_master' not in st.session_state or st.session_state.df_master is None:
            st.error("❌ Errore: dataset non disponibile.")
            st.stop()

        df = st.session_state.df_master
        insights = st.session_state.insights
        # ... il resto del tuo codice segue qui ...
